...
* First started using liquibase to manage database migrations but this project has been initialized with Spring Boot 3 which requires at least Java 17 and liquibase doesnt fully support Java 17 particularly liquibase:diff so will have to use the database DDL on file **ddl-to-use.sql**
